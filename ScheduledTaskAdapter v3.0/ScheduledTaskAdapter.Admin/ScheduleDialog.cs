...
namespace ScheduledTaskAdapter.Management
{
	...
	public class ScheduleDialog : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.TabPage tabTimeSpan;
		private System.Windows.Forms.ComboBox timeUnits;
		...
		public ScheduleDialog()
		{
			...
			this.timeSpan.Text = "1";
			this.timeUnits.SelectedItem = "Hours";
		}
		...
		private void InitializeComponent()
		{
            ...
            this.tabTimeSpan = new System.Windows.Forms.TabPage();
            this.timeUnits = new System.Windows.Forms.ComboBox();
            ...
            this.dayInterval.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.tabPages.Controls.Add(this.tabTimeSpan);
            ...
            this.tabDaily.Click += new System.EventHandler(this.tabDaily_Click);
            // 
            // tabWeekly
            // 
            ...
            this.tabWeekly.Click += new System.EventHandler(this.tabWeekly_Click);
            // 
            // tabMonthly
            // 
            ...
            this.tabMonthly.Click += new System.EventHandler(this.tabMonthly_Click);
            // 
            // tabTimeSpan
            // 
            this.tabTimeSpan.Controls.Add(this.timeUnits);
            this.tabTimeSpan.Controls.Add(this.labelUnits);
            this.tabTimeSpan.Controls.Add(this.labelInterval);
            this.tabTimeSpan.Controls.Add(this.timeSpan);
            this.tabTimeSpan.Location = new System.Drawing.Point(4, 22);
            this.tabTimeSpan.Name = "tabTimeSpan";
            this.tabTimeSpan.Size = new System.Drawing.Size(312, 214);
            this.tabTimeSpan.TabIndex = 3;
            this.tabTimeSpan.Text = "Time span";
            this.tabTimeSpan.Click += new System.EventHandler(this.tabTimeSpan_Click);
            // 
            // timeUnits
            // 
            this.timeUnits.Items.AddRange(new object[] {
            "Hours",
            "Minutes",
            "Seconds"});
            this.timeUnits.Location = new System.Drawing.Point(80, 40);
            this.timeUnits.Name = "timeUnits";
            this.timeUnits.Size = new System.Drawing.Size(128, 21);
            this.timeUnits.TabIndex = 14;
            // 
            // labelUnits
            // 
            this.labelUnits.Location = new System.Drawing.Point(16, 40);
            this.labelUnits.Name = "labelUnits";
            this.labelUnits.Size = new System.Drawing.Size(64, 23);
            this.labelUnits.TabIndex = 13;
            this.labelUnits.Text = "Units";
            // 
            // labelInterval
            // 
            this.labelInterval.Location = new System.Drawing.Point(16, 16);
            this.labelInterval.Name = "labelInterval";
            this.labelInterval.Size = new System.Drawing.Size(64, 20);
            this.labelInterval.TabIndex = 11;
            this.labelInterval.Text = "Interval";
            // 
            // timeSpan
            // 
            this.timeSpan.Location = new System.Drawing.Point(80, 16);
            this.timeSpan.Name = "timeSpan";
            this.timeSpan.Size = new System.Drawing.Size(128, 20);
            ...
            this.tabTimeSpan.PerformLayout();
		...
		private void LoadTimeSpanSchedule()
		{
			this.tabPages.SelectedTab = this.tabTimeSpan;
			int timeinseconds = Schedule.IfExistsExtractInt(configXml, "/schedule/timespan", 3600);
			if (timeinseconds % 3600 == 0)
			{
				this.timeSpan.Text = (timeinseconds/3600).ToString();
				this.timeUnits.SelectedItem = "Hours";
			}
			else if (timeinseconds % 60 == 0)
			{
				this.timeSpan.Text = (timeinseconds/60).ToString();
				this.timeUnits.SelectedItem = "Minutes";
			}
			else
			{
				this.timeSpan.Text = timeinseconds.ToString();
				this.timeUnits.SelectedItem = "Seconds";
			}
		}
		...
		private void UnloadTimeSpanSchedule()
		{
			configXml.DocumentElement.SetAttribute("type", "", "TimeSpan");
			if (timeSpan.Text != null && timeSpan.Text.Length > 0)
			{
				int number;
				try
				{
					number = int.Parse(timeSpan.Text);
				}
				catch
				{
					throw(new ApplicationException("Time span must be a number."));
				}
				XmlNode timeSpanNode = configXml.CreateNode("element", "timespan","");
				switch(this.timeUnits.SelectedItem.ToString())
				{
					case "Hours":
						timeSpanNode.InnerText = (number*3600).ToString();
						break;
					case "Minutes":
						timeSpanNode.InnerText = (number*60).ToString();
						break;
					default:
						timeSpanNode.InnerText = number.ToString();
						break;
				}
				configXml.DocumentElement.AppendChild(timeSpanNode);
			}
		}
		...
		private void tabTimeSpan_Click(object sender, System.EventArgs e)
		{
			dateStart.Enabled = true;
			timeStart.Enabled = true;
		}

		private void tabDaily_Click(object sender, System.EventArgs e)
		{
			dateStart.Enabled = true;
			timeStart.Enabled = true;
		}
		
		private void tabWeekly_Click(object sender, System.EventArgs e)
		{
			dateStart.Enabled = true;
			timeStart.Enabled = true;
		}

		private void tabMonthly_Click(object sender, System.EventArgs e)
		{
			dateStart.Enabled = true;
			timeStart.Enabled = true;
		}
