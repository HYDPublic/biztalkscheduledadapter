...
namespace ScheduledTaskAdapterManagement
{
	...
	public class TaskPropertiesDialog : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(TaskPropertiesDialog));
		...
		private void findButton_Click(object sender, System.EventArgs e)
		{
			...
			typeDialog.InterfaceType = typeof(IScheduledTaskStreamProvider);
		...
		private void textQualifiedName_TextChanged(object sender, System.EventArgs e)
		{
			...
			if (result != null)
			{
				...
				taskArguments = assembly.CreateInstance(result.ToString());
				propertyGrid.SelectedObject = taskArguments;
				loaded = true;
			}
			return;
